...
**MQTT协议-上下行消息处理能力压测**
> 单Broker8核16G，支持44万连接（进程启动内存5G、并开启心跳）；1万客户端 单消息1024B 下行tps: 16万+； 4000客户端 Publish 单消息1024B 上行tps: 17万+，千兆网卡流量基本打满。

**自定义协议-单机连接数支撑能力压测**

> 单Broker8核16G开启心跳机制，客户端每30秒发送一次心跳，支持65万连接，稳定运行10分钟后，系统负载不到2个，维持心跳包的网络带宽约4500KB，转换成网络带宽4500 * 8 / 1024≈35M，服务端毫无压力。由于测试资源限制，理论上可以支持百万连接。【基于自定义消息协议压测】
